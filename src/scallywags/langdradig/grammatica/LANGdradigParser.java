	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(32); match(KLAAR);
				setState(33); match(PUNT);
				}
				break;
			case 3:
			...
			case 4:
				...
				if (_la==NIET || _la==KLOPT) {
					...
					if (_la==NIET) {
						{
						setState(39); match(NIET);
						}
					}

					setState(42); match(KLOPT);
					}
				}

				setState(45); match(DAN);
				setState(46); statement();
				setState(49);
				switch ( getInterpreter().adaptivePredict(_input,5,_ctx) ) {
				case 1:
					{
					setState(47); match(ANDERS);
			...
			case 5:
				...
				case 1:
					...
					if (_la==NIET) {
						{
						setState(53); match(NIET);
						}
					}

					setState(56); match(KLOPT);
					}
					break;
				}
			...
			case 8:
				...
				{
				setState(73); match(WACHT);
				setState(74); match(OP);
				setState(75); match(IDENTIFIER);
				setState(76); match(PUNT);
				}
				break;
			case 9:
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(83); match(MIN);
				setState(84); expression(12);
				}
				break;
			case 2:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						setState(113); match(EN);
						setState(114); expression(7);
						}
						break;
					case 5:
						{
					...
					case 8:
						...
						setState(128); match(EN);
						setState(129); expression(0);
						setState(130); match(LIGT);
						}
						break;
					}
					} 
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			case LH:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(137); match(LH);
				setState(138); expression(0);
				setState(139); match(RH);
				}
				break;
			case WAAR:
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case REEKS:
				...
				enterOuterAlt(_localctx, 3);
				{
				setState(149); match(REEKS);
				setState(150); match(VAN);
