			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 8:
						...
						setState(139); match(OP);
						setState(140); match(DE);
						setState(141); match(TELWOORD);
						setState(142); match(PLEK);
						setState(143); match(WORDT);
						setState(144); expression(1);
						}
						break;
					case 9:
						{
						...
						setState(148); match(EN);
						setState(149); expression(0);
						setState(150); match(LIGT);
						}
						break;
					case 10:
						{
						...
						setState(153); match(OP);
						setState(154); match(DE);
						setState(155); match(TELWOORD);
						setState(156); match(PLEK);
						}
						break;
					}
					} 
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			case LH:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(162); match(LH);
				setState(163); expression(0);
				setState(164); match(RH);
				}
				break;
			case WAAR:
