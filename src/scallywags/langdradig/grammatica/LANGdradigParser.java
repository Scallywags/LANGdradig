...
public class LANGdradigParser extends Parser {
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"GROTEROFGELIJK", "WORDT", "ALS", "DAN", "ANDERS", "ZOLANG", "GETAL", 
		"STELLING", "REEKS", "WAAR", "ONWAAR", "PLEK", "LENGTE", "ZET", "PLAATS", 
		"KLOPT", "VERHOOG", "HOOG", "VERLAAG", "LIGT", "TUSSEN", "BINNEN", "BUITEN", 
		"DOE", "KLAAR", "KRITIEK", "BESTEED", "UIT", "AAN", "WACHT", "GEDEELDE", 
		"LAAT", "ZIEN", "PUNT", "KOMMA", "LH", "RH", "LSQ", "RSQ", "IS", "IN", 
		"EEN", "OP", "VAN", "DE", "NUMBER", "IDENTIFIER", "COMMENTAAR", "WITRUIMTE", 
		"ERRORCHARACTER"
	};
